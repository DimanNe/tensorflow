...
Module {
    ...
    cpp.includePaths: [
        ...
        // tensorFlowRootPath + "/bazel-out/local-dbg/genfiles",
        // tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/eigen_archive",

        tensorFlowRootPath + "/bazel-tensorflow/external/protobuf",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/bazel_tools",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/boringssl",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/com_googlesource_code_re2",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/curl",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/eigen_archive",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/farmhash_archive",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/fft2d",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/gemmlowp",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/gif_archive",

        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/highwayhash",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/jemalloc",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/jpeg",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/jsoncpp_git",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/local_config_cuda",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/local_config_sycl",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/png_archive",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/protobuf",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/snappy",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/zlib_archive",
    ...
    systemIncludePaths: [
        tensorFlowRootPath + "/bazel-tensorflow/external/protobuf/src",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/boringssl/src/include",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/curl/include",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/eigen_archive",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/farmhash_archive/src",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/gif_archive/lib",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/jemalloc/include",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/jsoncpp_git/include",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/local_config_cuda/cuda",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/local_config_cuda/cuda/include",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/png_archive",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/protobuf/src",
        tensorFlowRootPath + "/bazel-out/local-dbg/genfiles/external/zlib_archive",
